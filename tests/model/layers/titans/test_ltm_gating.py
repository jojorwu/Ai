...
class TestLTMGating(unittest.TestCase):
    ...
    def setUp(self):
        self.d_model = 32
        self.d_hidden = 64
        self.ltm = LongTermMemory(self.d_model, self.d_hidden)
        self.batch_size = 2
    ...
    def test_gating_mechanics(self):
        ...
        # Verify shapes
        self.assertEqual(mem1.shape, (self.batch_size, self.d_hidden, self.d_model))
    ...
    def test_normalization_effect(self):
        ...
        # Normalized output should have reasonable magnitude (approx sqrt(d_model) or similar depending on RMSNorm)
        # RMSNorm output magnitude is controlled by gamma (initialized to ones)
    ...
    def test_learnability(self):
        ...
        prev_mem = torch.randn(self.batch_size, self.d_hidden, self.d_model, requires_grad=True)
