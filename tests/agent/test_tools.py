...
class TestTools(unittest.TestCase):
    ...
    def test_execute_tool_shell_command_is_called(self):
        ...
        self.registry.tools["execute_shell"] = MagicMock(return_value="Success from mock")

        args = {"command": "ls -l"}
        result = self.registry.execute_tool("execute_shell", args)

        self.registry.tools["execute_shell"].assert_called_once_with(**args)  # pylint: disable=no-member
