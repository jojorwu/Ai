...
def test_swiglu_feed_forward_backward_gradient_check():
    """
    ...
    assert np.allclose(dx_analytic, dx_numerical, rtol=1e-4, atol=1e-4), "Gradient check for input dx FAILED"
...
if __name__ == "__main__":
    test_swiglu_feed_forward_backward_gradient_check()
